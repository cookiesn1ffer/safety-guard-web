...
function SettingsPage() { return <PageIntro eyebrow="Admin console / Settings" title="Keep the rules understandable." description="Configure review preferences without changing how the underlying scanner evaluates messages." icon={<Settings2 size={22} />}><section className="panel settings-panel"><SettingRow title="Store mail subjects" description="Keep subjects with reported event metadata for reviewers." checked /><SettingRow title="Require review for unverified links" description="Route incomplete verification results to the admin queue." checked /><SettingRow title="Notify on blocked destination" description="Send an alert when a newly inspected link is blocked." checked={false} /></section></PageIntro>; }
